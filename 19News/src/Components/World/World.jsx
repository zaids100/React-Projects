...
export const worldInfoLoader=async()=>{
    const response = await fetch('https://api.currentsapi.services/v1/latest-news?category=world&apiKey=mPn-n2zxSkYcGMSdkS5SYTcaeWuxW7fzjC4eU5oxUd4eqc4f');
